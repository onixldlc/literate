...
private:
  Utf16CodePointIterator(u16 const* ptr, size_t length) : m_ptr(ptr), m_remaining_code_units(length) {
    // TODO: implemented
  }
...
public:
  ...
  explicit Utf16View(Span<u16 const> code_units) : m_code_units(code_units) {
    // TODO: implemented
  }
  ...
  bool validate() const {
    ...
    return validate(valide_code_units);
  }
