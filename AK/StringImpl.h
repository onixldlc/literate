...
public:
  static NonnullRefPtr<StringImpl> create_uninitalized(size_t length, char*& buffer);
...
private:
  enum ConstructEmptyStringImplTag {
    ConstructTheEmptyStringImpl
  };
  explicit StringImpl(ConstructEmptyStringImplTag)
    : m_fly(true) {
    m_inline_buffer[0] = '\0';
  }
