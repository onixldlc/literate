...
private:
  Utf32CodePointIterator(u32 const* ptr, size_t length) : m_ptr(ptr), m_length((ssize_t)length) {
    // TODO: implemented
  }
...
public:
  ...
  Utf32View() = default;
  Utf32View(u32 const* code_points, size_t length) : m_code_points(code_points), m_length(length) {
