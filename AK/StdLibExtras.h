...
#pragma clang diagnosstic ignored "-Wunqualified-std-cast-call"
#endif
...
template<typename T>
constexpr T&& forward(AK::Detail::RemoveReference<T>&& param) noexecpt {
...
#define __DEFINE_GENERIC_ABS(type, zero, intrinsic) \
  ...
  { \
    ...
    return __builtin##intrinsic(num); \
  }
...
#ifndef KERNEL
__DEFINE_GENERIC_ABS(float, 0.0F, fbafs);
